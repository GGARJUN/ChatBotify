...
// import { getBotswithoutdocs } from '@/lib/api/bots';
...
//     // Fetch bots only when user.clientId is available and stable
//     useEffect(() => {
//         const fetchData = async () => {
//             if (!user || !user.clientId) {
//                 setBots([]); // reset bots if user or clientId missing
//                 setLoading(false);
//                 return;
//             }
...
//                 // Fetch bots using clientId
//                 const fetchedBots = await getBotswithoutdocs(token, user.clientId);
...
//                 setBots(sortedBots);
//                 console.log("bot details", sortedBots);
...
//         fetchData();
//     }, [user?.clientId]); // Only refetch when clientId changes
...
//                     </div>
//                     <div>
//                         <h2 className="font-bold text-xl text-slate-900">{document.length}</h2>
